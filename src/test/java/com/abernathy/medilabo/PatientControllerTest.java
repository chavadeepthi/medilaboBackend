...
public class PatientControllerTest {
    ...
    void testGetPatient_Success() throws Exception {
        ...
        mockMvc.perform(get("/patients").param("id", "1"))
    ...
    void testUpdatePatient() throws Exception {
        ...
        mockMvc.perform(put("/patients").param("id", "1")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testDeletePatient_Success() throws Exception {
        ...
        mockMvc.perform(delete("/patients").param("id", "1"))
                .andExpect(status().isOk());
    }

    @Test
    void testDeletePatient_NotFound() throws Exception {
        doThrow(new PatientNotFoundException(1L)).when(patientService).deletePatient(1L);
